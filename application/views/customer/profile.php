			...
			<div class="col-md-8">
				<nav>
					<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
						<a class="nav-item nav-link active" id="nav-umum-tab" data-toggle="tab" href="#nav-umum"
							role="tab" aria-controls="nav-umum" aria-selected="true">Update Data Diri</a>
						<a class="nav-item nav-link" id="nav-fitur" data-toggle="tab" href="#nav-fitur-mobil" role="tab"
							aria-controls="nav-fitur-mobil" aria-selected="false">Update Foto</a>
					</div>
				</nav>
				<div class="tab-content" id="nav-tabContent">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="email"
													value="<?= $this->session->userdata('email');?>" name="email">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="alamat"
													value="<?php echo $user['alamat']?>" name="alamat">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="No. Telp"
													value="<?php echo $user['no_telepon']?>" name="no_telepon">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="Nomor KTP"
													value="<?php echo $user['no_ktp']?>" name="no_ktp">
												<input type="hidden" name="no_ktp_old"
													value="<?php echo $user['no_ktp']?>">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="password" name="password" id="password"
													class="form-control" value="<?= set_value('') ?>"
												...
												<span class="eye" onclick="tampilPassword()">
													...
													<div id="tpassword1">
														<i class="icon-eye-slash mt-2"></i><span
															style="font-size: 12px;"> Tampilkan Password</span>
													</div>
												</span>
					...
					<div class="tab-pane fade show" id="nav-fitur-mobil" role="tabpanel" aria-labelledby="nav-home-tab">
						<div class="row mt-3">
							<div class="col-md-12 block-9 mb-md-5">
								<form action="<?= base_url('customer/update_foto')?>" class="bg-light p-4 contact-form"
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<img src="<?= base_url('assets/upload/user/ktp/'). $user['foto_ktp']?>"
													alt="foto-ktp" class="img-thumbnail w-25">
												<div class="custom-file mt-3">
													<input type="file" id="ktp" name="foto_ktp"
														class="custom-file-input form-control-lg" autofocus
														onchange="previewPhoto1()">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<img src="<?= base_url('assets/upload/user/avatar/' . $user['avatar'])?>"

				...
				<div class="bd-example bd-example-tabs">
						...
						<ul class="nav nav-pills " id="pills-tab" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" id="pills-description-tab" data-toggle="pill"
									...
									aria-expanded="true">Rental</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="pills-manufacturer-tab" data-toggle="pill"
									href="#pills-manufacturer" role="tab" aria-controls="pills-manufacturer"
									aria-expanded="true">Detail Mobil</a>
							</li>
						</ul>
					</div>
					<div class="tab-content" id="pills-tabContent">
								...
								<div class="col-12">
									<form action="<?= base_url('Customer/addRental/') . $detail['id_mobil'] ?>"
										...
										<div class="form-group">
											...
											<input type="text" name="alamat_penjemputan" class="form-control"
												value="<?= $user['alamat']; ?>">
											<span style="font-size: 12px !important;"
												class="help-block"><?= form_error('alamat_penjemputan'); ?></span>
										</div>
										<div class="d-flex">
											<div class="form-group mr-2">
												<label for="" class="label">Waktu Penjemputan</label>
												<input type="text" name="waktu_penjemputan" class="form-control"
													id="time_pick" placeholder="Jam"
													value="<?= set_value('waktu_penjemputan'); ?>">
												<span style="font-size: 12px !important;"
													class="help-block"><?= form_error('waktu_penjemputan'); ?></span>
											</div>
											<div class="form-group mx-2">
												<label for="" class="label">Tanggal Rental</label>
												<input type="text" name="tgl_rental" class="form-control"
													id="book_pick_date" placeholder="Tanggal"
													value="<?= set_value('tgl_rental'); ?>" readonly>
												<span style="font-size: 12px !important;"
													class="help-block"><?= form_error('tgl_rental'); ?></span>
											</div>
											<div class="form-group ml-2">
												<label for="" class="label">Tanggal Pengembalian</label>
												<input type="text" name="tgl_kembali" class="form-control"
													id="book_off_date" placeholder="Tanggal"
													value="<?= set_value('tgl_kembali'); ?>" readonly>
												<span style="font-size: 12px !important;"
													class="help-block"><?= form_error('tgl_kembali'); ?></span>
											</div>
										</div>
										<div class="d-flex">
											<div class="form-group mr-2">
												<label for="" class="label">Rental / Hari</label>
												<input type="text" name="hrg_hari" class="form-control"
													value="<?= $detail['harga']; ?>" readonly>
											</div>
											<div class="form-group mx-2">
												<label for="" class="label">Denda / Hari</label>
												<input type="text" name="dnd_hari" class="form-control"
													value="<?= $detail['denda']; ?>" readonly>
											</div>
											<!-- pengkondisian lepas kunci atau tidak -->
											<?php if ($detail['supir'] == 0) : ?>
											<div class="form-group mx-2">
												<label for="" class="label">Supir / Hari</label>
												<input type="text" name="hrg_supir" class="form-control"
													value="<?= $detail['hrg_supir']; ?>" readonly>
											</div>
											<?php else : ?>
											<div class="form-group mx-2">
												<label for="" class="label">Supir / Hari</label>
												<select class="form-control" name="hrg_supir">
													<option value="<?= $detail['hrg_supir'] ?>"
										...
										<div class="form-group mt-3">
											<input type="submit" value="Rental Sekarang" class="btn btn-secondary py-3"
												...
												onclick="return confirm('Yakin data anda sudah benar?')">
										</div>
										<div class="mt-5">
						...
						<div class="tab-pane fade" id="pills-manufacturer" role="tabpanel"
							aria-labelledby="pills-manufacturer-tab" style="padding-top: 0em !important;">
										...
										<div class="col-md-7">
											<div class="car-details py-3">
												<div class="img rounded"
													style="background-image: url(<?= base_url() ?>assets/upload/<?= $detail['gambar'] ?>);">
												</div>
											</div>
										</div>
										<div class="col-md-5">
											<div class="text text-center py-5">
												...
												<?php } else { ?>
												<h3 style="text-decoration: line-through;"><?= $detail['merek']; ?>
													(Dirental)</h3>
												<?php } ?>
												...
												<div class="row">
													<div
														class="col-md-4 col-sm-6 d-flex align-self-stretch ftco-animate">
														<div class="media block-6 services">
															<div class="media-body py-md-4">
																<div class="d-flex mb-3 align-items-center">
																	<div
																		class="icon d-flex align-items-center justify-content-center">
																		<span class="flaticon-dashboard"></span></div>
																	<div class="text">
														...
														<div class="media block-6 services">
															<div class="media-body py-md-4">
																<div class="d-flex mb-3 align-items-center">
																	<div
																		class="icon d-flex align-items-center justify-content-center">
																		<span class="flaticon-pistons"></span></div>
																	<div class="text">
																		<h3 class="heading mb-0 pl-3">
																			Transmisi
														...
														<div class="media block-6 services">
															<div class="media-body py-md-4">
																<div class="d-flex mb-3 align-items-center">
																	<div
																		class="icon d-flex align-items-center justify-content-center">
																		<span class="flaticon-car-seat"></span></div>
																	<div class="text">
																		<h3 class="heading mb-0 pl-3">
																			Kursi
														...
														<div class="media block-6 services">
															<div class="media-body py-md-4">
																<div class="d-flex mb-3 align-items-center">
																	<div
																		class="icon d-flex align-items-center justify-content-center">
																		<span class="flaticon-backpack"></span></div>
																	<div class="text">
																		<h3 class="heading mb-0 pl-3">
																			Bagasi
														...
														<div class="media block-6 services">
															<div class="media-body py-md-4">
																<div class="d-flex mb-3 align-items-center">
																	<div
																		class="icon d-flex align-items-center justify-content-center">
																		<span class="flaticon-diesel"></span></div>
																	<div class="text">
																		<h3 class="heading mb-0 pl-3">
																			BBM
											...
											<div class="bd-example bd-example-tabs">
												<div class="d-flex justify-content-center">
													<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
														...
														<li class="nav-item">
															<a class="nav-link" id="pills-description-tab"
																data-toggle="pill" href="#pills-description1" role="tab"
																aria-controls="pills-description1"
																aria-expanded="true">Features</a>
														</li>
														<li class="nav-item">
															<a class="nav-link active" id="pills-manufacturer-tab"
																data-toggle="pill" href="#pills-manufacturer1"
																role="tab" aria-controls="pills-manufacturer1"
																aria-expanded="true">Description</a>
														</li>
														<li class="nav-item">
															<a class="nav-link" id="pills-review-tab" data-toggle="pill"
																href="#pills-review1" role="tab"
																aria-controls="pills-review1"
												...
												<div class="tab-content" id="pills-tabContent">
													<div class="tab-pane fade" id="pills-description1" role="tabpanel"
														...
														<div class="row">
															<div class="col-md-4">
																<ul class="features">
																	<li
																		class="<?= $detail['ac'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['ac'] == '1' ? 'checkmark' : 'close'; ?>"></span>Airconditions
																	</li>
																	<li
																		class="<?= $detail['seat_belt'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['seat_belt'] == '1' ? 'checkmark' : 'close'; ?>"></span>Seat
																		Belt</li>
																	<li
																		class="<?= $detail['air'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['air'] == '1' ? 'checkmark' : 'close'; ?>"></span>Air
																	</li>
																	<li
																		class="<?= $detail['p3k'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['p3k'] == '1' ? 'checkmark' : 'close'; ?>"></span>P3K
																	</li>
																</ul>
															</div>
															<div class="col-md-4">
																<ul class="features">
																	<li
																		class="<?= $detail['audio_input'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['audio_input'] == '1' ? 'checkmark' : 'close'; ?>"></span>Audio
																		input</li>
																	<li
																		class="<?= $detail['bluetooth'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['bluetooth'] == '1' ? 'checkmark' : 'close'; ?>"></span>Bluetooth
																	</li>
																	<li
																		class="<?= $detail['mp3_player'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['mp3_player'] == '1' ? 'checkmark' : 'close'; ?>"></span>Music
																	</li>
																	<li
																		class="<?= $detail['vidio'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['vidio'] == '1' ? 'checkmark' : 'close'; ?>"></span>Vidio
																	</li>
																</ul>
															</div>
															<div class="col-md-4">
																<ul class="features">
																	<li
																		class="<?= $detail['central_lock'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['central_lock'] == '1' ? 'checkmark' : 'close'; ?>"></span>Remote
																		central locking</li>
																	<li
																		class="<?= $detail['ban_serep'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['ban_serep'] == '1' ? 'checkmark' : 'close'; ?>"></span>Roda
																		Cadangan</li>
																	<li
																		class="<?= $detail['car_kit'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['car_kit'] == '1' ? 'checkmark' : 'close'; ?>"></span>Peralatan
																		Mobil</li>
																	<li
																		class="<?= $detail['supir'] == '1' ? 'check' : 'remove'; ?>">
																		<span
																			class="ion-ios-<?= $detail['supir'] == '1' ? 'checkmark' : 'close'; ?>"></span><b>Lepas
																			Kunci</b></li>
																</ul>
															</div>
														</div>
													...
													<div class="tab-pane fade  show active" id="pills-manufacturer1"
													...
													<div class="tab-pane fade" id="pills-review1" role="tabpanel"
														...
														<div class="row">
															<div class="col-md-7">
																...
																<div class="review d-flex">
																	<div class="user-img"
																		style="background-image: url(<?= base_url() ?>assets/assets_customer/images/person_1.jpg)">
																	</div>
																	<div class="desc">
																		<h4>
																...
																<div class="review d-flex">
																	<div class="user-img"
																		style="background-image: url(<?= base_url() ?>assets/assets_customer/images/person_2.jpg)">
																	</div>
																	<div class="desc">
																		<h4>
																			<span class="text-left">Jacob Webb</span>
																...
																<div class="review d-flex">
																	<div class="user-img"
																		style="background-image: url(<?= base_url() ?>assets/assets_customer/images/person_3.jpg)">
																	</div>
																	<div class="desc">
																		<h4>
																			<span class="text-left">Jacob Webb</span>

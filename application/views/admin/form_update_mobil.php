<div class="main-content">
	<section class="section">
		...
		<div class="card">
			<form action="<?= base_url('admin/mobil/update_mobil/') . $mobil['id_mobil'] ?>" enctype="multipart/form-data"
				method="post">
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" name="jmlh_kursi" class="form-control" placeholder="ex: 7 Dewasa"
											value="<?php echo $mobil['jmlh_kursi']?>">
